...
const App: React.FC = () => {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-gray-900 to-blue-900 text-white">
      <header className="absolute top-0 left-0 w-full p-4 z-10 text-center md:text-left [text-shadow:-1px_-1px_0_#000,1px_-1px_0_#000,-1px_1px_0_#000,1px_1px_0_#000]">
